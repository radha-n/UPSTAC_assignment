...
class ConsultationControllerTest {
    ...
    public void calling_assignForConsultation_with_valid_test_request_id_should_update_the_request_status(){
        ...
        TestRequest request = consultationController.assignForConsultation(testRequest.getRequestId());

        assertThat(request.getRequestId(),equalTo(testRequest.getRequestId()));
        assertThat(request.getStatus(),equalTo(RequestStatus.DIAGNOSIS_IN_PROCESS));
    ...
    public void calling_assignForConsultation_with_valid_test_request_id_should_throw_exception(){
        ...
        ResponseStatusException message = assertThrows(ResponseStatusException.class,() -> {
            consultationController.assignForConsultation(InvalidRequestId);
        });
        assertThat(message.getMessage(),containsString("Invalid ID"));
    }
    ...
    public void calling_updateConsultation_with_valid_test_request_id_should_update_the_request_status_and_update_consultation_details(){
        ...
        TestRequest testRequest1 = consultationController.updateConsultation(testRequest.getRequestId(), consultationRequest);

        assertThat(testRequest1.getRequestId(),equalTo(testRequest.getRequestId()));
        assertThat(testRequest1.getStatus(),equalTo(RequestStatus.COMPLETED));
        assertThat(testRequest1.getConsultation().getSuggestion(),equalTo(consultationRequest.getSuggestion()));
    ...
    public void calling_updateConsultation_with_invalid_test_request_id_should_throw_exception(){
        ...
        ResponseStatusException message = assertThrows(ResponseStatusException.class,() -> {
            consultationController.updateConsultation(-25L,consultationRequest);
        });
    ...
    public void calling_updateConsultation_with_invalid_empty_status_should_throw_exception(){
        ...
        assertThat(message.getMessage(),containsString("ConstraintViolationException"));
    ...
    public CreateConsultationRequest getCreateConsultationRequest(TestRequest testRequest) {
        ...
        if(createLabResult.getResult().equals(TestStatus.POSITIVE)){
            ...
            consultationRequest.setComments("Please take prescribed medicines and stay in home and avoid contact with anyone.");
        }
        else {
