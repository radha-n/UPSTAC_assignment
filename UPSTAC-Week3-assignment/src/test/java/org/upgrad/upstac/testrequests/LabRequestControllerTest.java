...
class LabRequestControllerTest {
    ...
    public void calling_assignForLabTest_with_valid_test_request_id_should_update_the_request_status(){
        ...
        //Create another object of the TestRequest method and explicitly assign this object for Lab Test
        // using assignForLabTest() method from labRequestController class. Pass the request id of testRequest object.
    ...
    public void calling_updateLabTest_with_valid_test_request_id_should_update_the_request_status_and_update_test_request_details(){
        ...
        assertThat(testRequest1.getLabResult(),equalTo(createLabResult.getResult()));
    ...
    public void calling_updateLabTest_with_invalid_test_request_id_should_throw_exception(){
        ...
        ResponseStatusException message = assertThrows(ResponseStatusException.class,() ->{
            labRequestController.updateLabTest(-25L,createLabResult);
        });
    ...
    public CreateLabResult getCreateLabResult(TestRequest testRequest) {
        ...
        createLabResult.setComments("Looks fine");
        createLabResult.setBloodPressure("120/90");
