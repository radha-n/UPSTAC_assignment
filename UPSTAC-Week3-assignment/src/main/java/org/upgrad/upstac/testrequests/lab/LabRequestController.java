...
public class LabRequestController {
    ...
    public List<TestRequest> getForTests()  {
        ...
        //returns the test requests having status as "INITIATED"
    ...
    public List<TestRequest> getForTester()  {
        ...
        // Create a Object of User class and get the current logged in user(tester).
        User loggedInTester = userLoggedInService.getLoggedInUser();

        //returns all the test requests for the currently logged in tester.
    ...
    public TestRequest assignForLabTest(@PathVariable Long id) {
        ...
        //return assigned test request id with currently logged in user (tester)
    ...
    public TestRequest updateLabTest(@PathVariable Long id,@RequestBody CreateLabResult createLabResult) {
        ...
        try {
            ...
            //returns the test request id with the updated test results details by currently logged in user(tester)
