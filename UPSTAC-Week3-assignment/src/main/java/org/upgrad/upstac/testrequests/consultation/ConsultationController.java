...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        //returns the test requests having status as "LAB_TEST_COMPLETED"
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        // Create a Object of User class and get the current logged in user(doctor)
        User loggedInDoctor = userLoggedInService.getLoggedInUser();

        //returns all the test requests assigned to currently logged in doctor
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        try {
            //Create an object of User class and get the current logged in user(doctor)
            User loggedInDoctor = userLoggedInService.getLoggedInUser();

            //create an Object of TestRequest class and return that object with assigning the test request id
            // to currently logged in user(doctor)
            TestRequest consultation = testRequestUpdateService.assignForConsultation(id,loggedInDoctor);
            return  consultation;
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        try {
            ...
            //create an Object of TestRequest class and return that object to update the test request id with the test results
            // details by currently logged in user(doctor)
            TestRequest consultation = testRequestUpdateService.updateConsultation(id,testResult,loggedInDoctor);
            return consultation;
